...
In the lecture we covered the memory allocation, initialization, removing overlaps, calculating 
collision times, and enforcing periodic boundary conditions for an event-driven
molecular dynamics simulation of hard disks in two dimensions. Complete the simulation
program by writing:

(a) a Python function that would update the relevant collision times after the collision of
particles i and j; and

(b) a Python script that would simulate M = 106 collisions for a system containing N =
102 hard disks with radius b = 0.002 in a unit box.
